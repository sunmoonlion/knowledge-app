...
deploy_app() {
    ...
    export CELERYWORKER_TPL_ADMIN_BACKEND_IMAGE_PROJECT="${CELERYWORKER_TPL_ADMIN_BACKEND_IMAGE_PROJECT:-k8s-images}"
    ...
    if [ -f "$CELERYWORKER_TPL_ADMIN_BACKEND_PVC_YAML" ]; then
        log_info "部署 PVC..."
